...
def is_sensitivity_config(value, *, required=True):
    ...
    return value["analysis_type"] in ["curtailment", "climate_years", "technology_scenario", "baseload", "hydropower_capacity", "interconnection_capacity", "interconnection_efficiency", "self_sufficiency"]
