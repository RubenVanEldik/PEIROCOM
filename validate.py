...
def is_sensitivity_config(value, *, required=True):
    ...
    return value["analysis_type"] in ["curtailment", "climate_years", "technology_scenario", "baseload", "hydropower_capacity", "interconnection_capacity", "interconnection_efficiency", "min_self_sufficiency", "max_self_sufficiency"]
...
def is_technology(value, *, required=True):
    ...
    ires_technologies = ["pv", "onshore", "offshore"]
    ...
    return value in ires_technologies or value in hydropower_technologies or value in storage_technologies
...
def is_technology_type(value, *, required=True):
    ...
    return value in ["ires", "hydropower", "storage"]
