...
def is_sensitivity_config(value, *, required=True):
    ...
    return value["analysis_type"] in ["curtailment", "climate_years", "technology_scenario", "hydrogen_demand", "dispatchable_generation", "hydropower_capacity", "interconnection_capacity", "interconnection_efficiency", "min_self_sufficiency", "max_self_sufficiency"]
