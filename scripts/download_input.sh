...
do
  mkdir "/app/input/scenarios/${scenario}/bidding_zones"
  ...
  do
    echo "${INPUT_DATA_URL}/${scenario//[ ]/_}/bidding_zones/${bidding_zone}.csv"
  done
done
...
for scenario in "ERAA 2025" "ERAA 2030"
do
  mkdir "/app/input/scenarios/${scenario}/interconnections"
  cd "/app/input/scenarios/${scenario}/interconnections"
  for interconnection_type in hvac hvdc limits
  do
    echo "${INPUT_DATA_URL}/${scenario//[ ]/_}/interconnections/${interconnection_type}.csv"
  done
done
